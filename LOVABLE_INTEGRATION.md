...
## Использование Railway Volume для хранения

Для постоянного хранения мира и бэкапов:

1. **Создать Volume на Railway:**
   - В настройках проекта создать новый Volume
   - Подключить к сервису

2. **Монтировать Volume:**
   - В настройках сервиса указать путь монтирования
   - Например: `/minecraft/data` → Volume

3. **Использовать в скриптах:**
   - Сохранять мир и бэкапы в смонтированную директорию
